...
| `evaluator_guidance_ablation.json` | Ensemble detection rates per rung under guided (risk-description) vs blind (generic policy question) evaluator modes on identical fresh generations (addresses "privileged context" concern; App. `Tab. guidance`) |
