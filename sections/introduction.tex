...
Formally, the \emph{safety gap} is the regime where the text filter passes the prompt and the visual checker passes the image, yet the image already falls in a nontrivial severity band: on \dataname's four-rung ladder this concentrates at the L1--L2 boundary, where defenses are weakest but risk is already present.
