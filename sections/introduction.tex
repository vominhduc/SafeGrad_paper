...
We note that each dimension is evaluated independently, with T2I models tested raw, defenses on a common base model (SD1.4), filters on benchmark reference images, and attacks against the best-defended configuration.
