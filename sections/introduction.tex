...
Each dimension is evaluated independently: T2I models are tested raw, defenses on a common base model (SD1.4), filters on benchmark reference images (with the tuned filter additionally validated on fresh model generations), and attacks against the best-defended configuration.
