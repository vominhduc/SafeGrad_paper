...
\textbf{(4) Adversarial attacks:} we test 5 jailbreak strategies, showing that cross-modal attacks (ASR $\geq$ 63\%) outperform gradient-based methods against the best-defended configurations.
