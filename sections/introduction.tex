...
Consequently, an evaluation framework that pinpoints the boundary failures of these safety systems through their underlying vulnerabilities is needed.
...
To address the aforementioned phenomenon, we introduce \dataname, a benchmark designed to map the severity-graded landscape of T2I models (\Fig{\ref{fig:overview}}). 
...
Collectively, these evaluations yield 8 insights showing that current binary safety strategies are fundamentally ill-equipped to address the severity-graded nature of T2I risk.
