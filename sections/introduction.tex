...
We identify a critical ``safety gap'' rooted in this systematic underestimation of graded harm: text filters fail on adversarial prompts, while visual checkers misclassify low/mid-risk imagery as ``safe,'' missing harm simulated through semantics; particularly hazardous for sensitive applications such as child-oriented platforms or enterprise safe-search.
