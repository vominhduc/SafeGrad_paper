...
\textbf{Severity monotonicity.} Spearman $\rho = 0.962$ between rung index and verifier risk scores measures rubric-internal consistency of the construction pipeline; human grounding of the rung labels is established separately by the blinded validation study ($\kappa = 0.73$; \SuppSec{\ref{app:human}}).
