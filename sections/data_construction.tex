...
Note that this verifier is not in tension with the filter failures of Insight 5: verification is a severity-conditioned, description-guided judgment, whereas deployed filters issue unguided binary decisions (cf. Insight 6).
