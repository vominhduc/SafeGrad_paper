...
The result transfers to fresh generations from all six evaluated models (bypass at most 2.7\%), confirming the diagnosed gap is trainable rather than intrinsic.
