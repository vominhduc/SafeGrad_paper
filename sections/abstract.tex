...
A severity-aware filter fine-tuned on ladder data cuts the bypass rate from 88.0\% to 2.2\% at L1, outperforming all five baselines and transferring to fresh generations from every evaluated model.
The diagnosed gap is therefore trainable rather than intrinsic to the models.
