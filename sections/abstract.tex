...
A severity-aware filter fine-tuned on ladder data attains 95.2\% detection at L1 with a 3.8\% L0 false-positive rate, cutting the overall bypass rate from 88.0\% to 2.2\% and dominating all five baselines on every metric.
