...
Severity-graded ideas have also appeared outside T2I generation: BingoGuard~\citep{yin2025bingoguard} assigns five risk levels to LLM text responses, and VLSU~\citep{palaskar2026vlsu} labels multimodal inputs safe/borderline/unsafe; neither examines generative severity in T2I synthesis.\n\dataname provides the first graded diagnostic across all four severity rungs.
